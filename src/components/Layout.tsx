        ...
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-700 to-slate-800 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-12 opacity-90">
              Contact Bare Acre Hauling today for fast, professional junk removal in Molalla and surrounding areas.
            </p>
            <div className="grid md:grid-cols-3 gap-8 text-left">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:BareAcreHauling@outlook.com" className="hover:text-green-400 transition-colors">BareAcreHauling@outlook.com</a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="mt-12 pt-8 border-t border-slate-600">
              ...
              <p className="opacity-90">Professional junk removal — we haul it all so you don't have to</p>
            </div>
          </div>
        </section>
      )}
